					...
					<Grid container justifyContent={'space-between'}>
						...
						<Paper className={classes.form} component={'form'}>
							...
							<Typography>
								...
								name, email address or other details to help you
							...
							<Typography>
								...
								register on our site or enter information on our
								site.
							</Typography>
							...
							<Typography>
								...
								cookie enables it to serve ads to our users
							...
							<Typography>
								...
								cookies (such as the DoubleClick cookie) or
								other third-party identifiers together to
							...
							<Typography>
								...
								or by using the Google Analytics Opt Out Browser
								add on.
							</Typography>
