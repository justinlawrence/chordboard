				...
				<Hero>
					<ContentLimiter>
						...
						<Grid container justify="space-between">
							<Grid item>
								<Typography variant="display1" color="inherit">Privacy</Typography>
							</Grid>
							...
							<Paper className={classes.form} component="form">
									...
									<Typography>We do not use cookies for tracking purposes </Typography>
									...
									<Typography>We use Google AdSense Advertising on our website.</Typography>
								...
								<Typography>How does our site handle Do Not Track signals?</Typography>
