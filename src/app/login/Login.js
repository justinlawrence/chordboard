					...
					<form onSubmit={this.handleLogin}>
						<Paper className={classes.form} elevation={10}>
							<Grid container alignItems="center" direction="column">
								...
								<Button variant="outlined" className={classes.button} type="submit" fullWidth>
									Login
								</Button>
								...
								<Typography className={classes.addPaddingTop}>Prefer not to log in?</Typography>

								<Button href={'https://immutable.chordboard.co'}>Go to the previous version</Button>
							</Grid>
						</Paper>
					</form>
				</Grid>
